            ...
            <div className="addProduct-form">
                ...
                {products.map((product) => (
                    <div className="viewCart-product" style={{fontSize: "1.4vw",color: "grey", backgroundColor: "whitesmoke", margin : "5px", minHeight : "1vw", width: "100%", padding: "1vw 0vw"}}>
                        ...
                        <div>
                            <select style={{backgroundColor : "white",textAlign:"center"}}>
                            {[...Array(10)].map((x, i) => (
                                <option>{i+1}</option>
                            )
                            )}
                        ...
                        <div>
                            <Link style={{color: "#f34653"}} to={'/new'}>X</Link>
                        </div>
                    </div>
                ))}
                ...
                <button style={{float: "right"}} type="button" name="submitBtn" class="button submitButton  gsc_col-xs-12 gsc_col-md-12 "><div style={{fontWeight:"900"}}>Pay Now</div></button>
                <br></br>
            </div>
        </div>
    )
